...
# test_set = ['charliehebdo-all-rnr-threads.txt','germanwings-crash-all-rnr-threads.txt','ottawashooting-all-rnr-threads.txt','sydneysiege-all-rnr-threads.txt']
...
for test_file in test_set:
	...
	for filename in files:
		...
		for row in input_file:
			...
			# x = convert_tree_to_tensors(curr_tree)
