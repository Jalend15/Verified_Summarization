...
output_path = "/Users/jalend15/Downloads/Verified-Summarization-master/Parsed-Trees_stance/"

parsed_reactions_path = "/Users/jalend15/Downloads/Verified-Summarization-master/parsed_reactions/"

parsed_source_path = "/Users/jalend15/Downloads/Verified-Summarization-master/parsed_source/"

pos_source_path = "/Users/jalend15/Downloads/Verified-Summarization-master/pos_source"

pos_reaction_path = "/Users/jalend15/Downloads/Verified-Summarization-master/pos_reaction/"


stance_path = "/Users/jalend15/Downloads/stance.json"
...
def main():
    ...
    feature_file = codecs.open(
        '/Users/jalend15/Downloads/Verified-Summarization-master/CTP/output_30_10_1000/tweet-posteriors.txt', 'r',
        'utf-8')
    ...
    for dataset in datasets:
        ...
        for tweet_id in rumour_tweets:
            ...
            date_created = datetime.strptime(d["created_at"],
                                             '%a %b %d %H:%M:%S %z %Y')  # .replace(tzinfo=timezone.utc).astimezone(tz=None).strftime('%Y-%m-%d %H:%M:%S'))
            ...
            for r_tweet_id in reaction_tweets:
                ...
                if r_tweet_id.split('.')[0] not in stance_dict:
                    ...
                    STANCE_LABELS[r_tweet_id.split('.')[0]] = stance_mapping.get(stance_dict[r_tweet_id.split('.')[0]])
            ...
            if tweet_id not in stance_dict:
                ...
                STANCE_LABELS[tweet_id] = stance_mapping.get(stance_dict[tweet_id])
